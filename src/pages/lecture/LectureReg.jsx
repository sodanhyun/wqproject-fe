                      ...
                      <div className="col-span-full">
                        ...
                        <div className="mt-2 flex">
                          <input
                            ...
                            type="datetime-local"
                            id="starttimepicker"
                            className="block mr-2 w-56 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6 px-1.5"
                          ...
                          <input
                            ...
                            type="datetime-local"
                            id="endtimepicker"
                            className="block ml-2 w-56 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6 px-1.5"
                            min={new Date().toISOString().slice(0, 16)}
                          />
                        </div>
                      </div>
