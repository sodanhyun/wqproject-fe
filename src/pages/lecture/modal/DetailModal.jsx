        ...
        <Dialog className="relative z-100" initialFocus={cancelButtonRef} onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <div
                    className="relative transform overflow-hidden rounded-lg bg-white px-2 pb-2 pt-2 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:p-6">
