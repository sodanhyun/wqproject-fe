...
const LectureReg = ({ lCode, onClose }) => {
  ...
  const formattedSDate = getFormattedDate(lectureData.sdate);
  const formattedEDate = getFormattedDate(lectureData.edate);
          ...
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              {imageLoadError ? (
                ...
                <img src={imageURL} alt="Lecture" onError={handleImageError} />
              )}
            </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex flex-col">
                <p>{formattedSDate}</p>~<p>{formattedEDate}</p>
              </div>
            </div>
