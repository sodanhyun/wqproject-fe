...
import LectureDetailForm from "../pages/LectureDetailForm.jsx";
import LectureModifyForm from "../pages/LectureModifyForm.jsx";
                ...
                <div
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    <h3  className="text-base font-semibold leading-6 text-gray-900">
                      { isShowDetailForm ? <LectureDetailForm lCode={lCode} fetchLectureData={fetchLectureData} onClose={onClose}/>
